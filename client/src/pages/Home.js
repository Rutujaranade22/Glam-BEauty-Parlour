...
export default function HeroSection() {
  return (
    <div
      ...
      style={{ backgroundImage: "url('/images/bg2.jpg')" }}  // your img from public
    >
      ...
      <section className="relative z-10 flex flex-col items-center text-center justify-center h-[80vh] px-6 md:px-20 text-white">
        <h2 className="text-5xl md:text-7xl font-extrabold leading-tight drop-shadow-lg">
          Glam Beauty <br /> <span className="text-yellow-500">Parlour</span>
        </h2>
        <p className="mt-4 max-w-2xl  text-yellow-950 text-lg md:text-xl drop-shadow-md">
      ...
      {/* Stats */}
      <div className="relative z-10 grid grid-cols-3 gap-6 text-center bg-black/40 py-6 px-10 md:px-32 text-white">
        <div>
